...
export default class Login extends Component {
  ...
  render() {
    const { redirect, userID, invalidCreds, forgotPassword } = this.state;
    if (redirect)
      return (
        <Redirect
          to={{
            ...
            <Col lg="9" className="mt-5 pt-4 mb-4">
              ...
              <Row>
                <Col lg="10" className="mt-5">
                  <Button onChange={this.handleChangeButton}>
                    {" "}
                    I Forgot My Password
                  </Button>
                  <ReactModal
                    isOpen={forgotPassword}
                    style={{ overlay: {top: 100, left:100, right:100, bottom:100}, content: {textAlign:'center', fontSize: 30} }}
                  >Reset Your Password: </ReactModal>
                </Col>
              </Row>
            </Col>
          </Row>
